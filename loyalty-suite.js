(function () {
    ...
    const initialCatalog = [
        { id: 'p1', name: 'Пицца Маргарита', category: 'pizza', price: 500, img: 'https://via.placeholder.com/240x160?text=Маргарита' },
        { id: 'p2', name: 'Пицца Пепперони', category: 'pizza', price: 620, img: 'https://via.placeholder.com/240x160?text=Пепперони' },
        { id: 'c1', name: 'Комбо «Ролл-дей»', category: 'combo', price: 1149, img: 'https://via.placeholder.com/240x160?text=Комбо' },
        { id: 'd1', name: 'Газировка', category: 'drink', price: 150, img: 'https://via.placeholder.com/240x160?text=Напиток' },
        { id: 'r1', name: 'Ролл с крабом', category: 'roll', price: 350, img: 'https://via.placeholder.com/240x160?text=Краб' }
    ];
    ...
    function hydrateFromBackend() {
        loyaltyApi.loadConfig().then(function (data) {
            ...
            state.apiMessage = 'Не удалось загрузить данные из API: ' + error.message;
            render();
        });
    }
